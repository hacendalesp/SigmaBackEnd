...
public class ConsultaGestionDAO extends GenericoDAO implements IConsultaGestionDAO {
	...
	public ObjetoSalida listarPanelPendienteTarea(GestionOE OE) {
        ...
        try 
        {
            SentenciaDAO sentencia = new SentenciaDAO("PKG_GESTION.pr_gestion_pendiente_tareas_panel", OE.getUsuario());
            List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
            parametros.add(new SentenciaParametroDAO("p_id_usuario", OE.getIdUsuario(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            //el parametro p_usuario es seteado en la clase que hereda GenericoDAO
            sentencia.setParametros(parametros);
	...
	public ObjetoSalida listarGestionPendienteTarea(GestionOE OE) {
        ...
        try 
        {
            SentenciaDAO sentencia = new SentenciaDAO("PKG_GESTION.pr_gestion_tarea_pendiente_x_usu_act", OE.getUsuario());
            List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
            parametros.add(new SentenciaParametroDAO("p_id_usuario", OE.getIdUsuario(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            parametros.add(new SentenciaParametroDAO("p_id_actividad_tarea", OE.getIdActividadTarea(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
