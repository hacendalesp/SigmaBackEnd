...
import co.gov.umv.sigma.backend.produccion.dao.impl.OrdenProduccionDetalleDAO;

public class OrdenProduccioDetalleDTO implements ICrudDTO
{

	OrdenProduccionDetalleDAO modelo = new OrdenProduccionDetalleDAO();
