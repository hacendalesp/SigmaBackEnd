...
public class ConsultaDAO extends GenericoDAO implements IConsultaDAO
{
	...
	@Override
	public ObjetoSalida consultarMantenimientoVialEventoAnterior(ConsultaOE OE) {
		ObjetoSalida objetoSalida = new ObjetoSalida();
	    try 
	    {
	        SentenciaDAO sentencia = new SentenciaDAO(PACKAGE+".prc_mantenimiento_vial_evento_anterior", OE.getUsuario());
	        List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
	        sentencia.setParametros(parametros);
	        
	        parametros.add(new SentenciaParametroDAO("p_id_mantenimiento_vial", OE.getIdMantenimientoVial(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
	        parametros.add(new SentenciaParametroDAO("p_area", OE.getAreaResponsable(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
	...
	@Override
	public ObjetoSalida consultarUnidadesEjecutoras(ConsultaOE OE) 
	{ 
		ObjetoSalida objetoSalida = new ObjetoSalida();
	    try {
	        SentenciaDAO sentencia = new SentenciaDAO(PACKAGE+".prc_consultarUnidadesEjecutoras", OE.getUsuario());
	        List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
	        sentencia.setParametros(parametros);
	...
	@Override
	public ObjetoSalida ConsultarFotosMantenimientoVial(ConsultaOE OE) 
	{ 
		ObjetoSalida objetoSalida = new ObjetoSalida();
	    try {
	        SentenciaDAO sentencia = new SentenciaDAO(PACKAGE+".prc_FotosMantenimientoVial", OE.getUsuario());
	        List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
	        sentencia.setParametros(parametros);
