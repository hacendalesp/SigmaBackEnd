...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ProgDiariaCalidadDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ProgDiariaCalidadDTO implements ICrudDTO
{
	ICrudDAO modelo = new ProgDiariaCalidadDAO();
