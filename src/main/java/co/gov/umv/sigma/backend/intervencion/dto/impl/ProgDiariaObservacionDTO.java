...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ProgDiariaObservacionDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ProgDiariaObservacionDTO  implements ICrudDTO
{
	ICrudDAO modelo = new ProgDiariaObservacionDAO();
