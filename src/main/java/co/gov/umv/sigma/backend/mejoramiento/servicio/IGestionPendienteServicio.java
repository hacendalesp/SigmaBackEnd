...
public interface IGestionPendienteServicio 
{
	...
	@POST
	@JWT
	@Path("/avanzarMantenimientosVialesMasivoGenerarFicha") 
	...
	@POST
	//@JWT
    @Path("/listarPanelGestionPendienteTarea")
    @Produces({ MediaType.APPLICATION_JSON})
	public Response listarPanelGestionPendienteTarea(GestionOE OE);   //{ "usuario":"rocio.guio","idUsuario":1379}
	
	
	@POST
	@JWT
	@Path("/listarBandejaGestionPendienteTarea") 
    @Produces({ MediaType.APPLICATION_JSON})
	public Response listarBandejaGestionPendienteTarea(GestionOE OE); //{ "usuario":"rocio.guio","idUsuario":1379, "idActividad":5}
