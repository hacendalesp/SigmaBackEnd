...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ProgDiariaSalidaMaterialDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ProgDiariaSalidaMaterialDTO implements ICrudDTO
{
	ICrudDAO modelo = new ProgDiariaSalidaMaterialDAO();
