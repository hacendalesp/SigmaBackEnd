...
import co.gov.umv.sigma.backend.produccion.dao.impl.OrdenProduccionDAO;

public class OrdenProduccionDTO implements ICrudDTO
{

	OrdenProduccionDAO modelo = new OrdenProduccionDAO();
