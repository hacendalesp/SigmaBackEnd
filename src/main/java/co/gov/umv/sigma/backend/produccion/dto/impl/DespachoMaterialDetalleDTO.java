...
import co.gov.umv.sigma.backend.produccion.dao.impl.DespachoMaterialDetalleDAO;

public class DespachoMaterialDetalleDTO  implements ICrudDTO
{

	DespachoMaterialDetalleDAO modelo = new DespachoMaterialDetalleDAO();
