...
import co.gov.umv.sigma.backend.produccion.dto.impl.GestionMezclaFormulaDTO;
...
public class ProduccioServicio implements IProduccionService
{
	...
	{
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.insertarMezclaFormula(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	{
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.actualizarMezclaFormula(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	{
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.insertarMateriaPrima(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	{
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.actualizarMateriaPrima(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	@Override
	public Response listarIdTipoMezcla(ProduccionOE OE) 
	{
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.listarIdTipoMezcla(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}


	@Override
	public Response listarIdTipoInsumo(ProduccionOE OE) {
		GestionMezclaFormulaDTO dto = new GestionMezclaFormulaDTO();
		ObjetoSalida os = dto.listarIdTipoInsumo(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
