...
public class TabMantenimientoEquipo {
	...
	private Long 	vigenciaContrato;
	private Integer idTipoMantenimiento;
	private String 	motivoCancelacion;
	private Integer estado;
	private String  sigla;
	
	private String ubicacionMtto;
	...
	public void ajustarCodigo()
	{
        ...
        int year =  vigenciaContrato != null ?  vigenciaContrato.intValue() % 100 :  Calendar.getInstance().get(Calendar.YEAR) % 100;
	...
	public Long getVigenciaContrato() {
		return vigenciaContrato;
	}


	public void setVigenciaContrato(Long vigenciaContrato) {
		this.vigenciaContrato = vigenciaContrato;
	}


	public String getUbicacionMtto() {
		return ubicacionMtto;
	}


	public void setUbicacionMtto(String ubicacionMtto) {
		this.ubicacionMtto = ubicacionMtto;
	}
