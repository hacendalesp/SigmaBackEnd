...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ProgDiariaCantidadObraDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ProgDiariaCantidadObraDTO implements ICrudDTO
{
	ICrudDAO modelo = new ProgDiariaCantidadObraDAO();
