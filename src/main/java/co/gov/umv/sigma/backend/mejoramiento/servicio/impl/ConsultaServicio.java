...
public class ConsultaServicio implements IConsultaServicio {
	...
	public Response consultaProgramacionDiaria(ConsultaOE OE) {
		ConsultasProgramacionDiariaDTO consulta = new ConsultasProgramacionDiariaDTO();
	...
	@Override
	public Response consultarMantenimientoVialEventoAnterior(ConsultaOE OE) {
		IConsultaDTO consulta = new ConsultaDTO();
		ObjetoSalida os = consulta.consultarMantenimientoVialEventoAnterior(OE);
		return Response.status(Response.Status.OK).entity(os).build();
	}

	@Override
	public Response fotosMantenimientoVial(ConsultaOE OE) {
		IConsultaDTO consulta = new ConsultaDTO();
		ObjetoSalida os = consulta.ConsultarFotosMantenimientoVial(OE);		
		return Response.status(Response.Status.OK).entity(os).build();
	}
