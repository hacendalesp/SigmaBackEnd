...
public class ConsultaDTO implements IConsultaDTO {
	...
	public ObjetoSalida consultarMantenimientoVialEventoAnterior(ConsultaOE OE) {
		IConsultaDAO modelo = new ConsultaDAO();
		return modelo.consultarMantenimientoVialEventoAnterior(OE);
	}

	@Override
	public ObjetoSalida consultarUnidadesEjecutoras(ConsultaOE OE) 
	{
		IConsultaDAO dao = new ConsultaDAO();
		return dao.consultarUnidadesEjecutoras(OE);
	}

	@Override
	public ObjetoSalida ConsultarFotosMantenimientoVial(ConsultaOE OE) {
		IConsultaDAO dao = new ConsultaDAO();
		return dao.ConsultarFotosMantenimientoVial(OE);
	}
