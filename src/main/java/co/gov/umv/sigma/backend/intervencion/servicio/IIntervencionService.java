...
public interface IIntervencionService {
	...
	@POST
    @Path("/programacionPeriodica/eliminarPKs")
    @Consumes({ MediaType.APPLICATION_JSON})
    @Produces({ MediaType.APPLICATION_JSON})
	@JWT		
	...
	@POST
    @Path("/tipoClaseMaterial/filtrarXTipo")
    @Consumes({ MediaType.APPLICATION_JSON})
    @Produces({ MediaType.APPLICATION_JSON})
	@JWT		
	...
	@POST
    @Path("/confPersonal/listarResidentesXDirector")
    @Consumes({ MediaType.APPLICATION_JSON})
    @Produces({ MediaType.APPLICATION_JSON})
	@JWT		
	...
	@POST
    @Path("/confPersonal/listarApoyoXDirector")
    @Consumes({ MediaType.APPLICATION_JSON})
    @Produces({ MediaType.APPLICATION_JSON})
	@JWT		
