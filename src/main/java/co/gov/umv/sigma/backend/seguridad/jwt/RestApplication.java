...
import co.gov.umv.sigma.backend.produccion.servicio.impl.DespachoMaterialServicio;
...
import co.gov.umv.sigma.backend.produccion.servicio.impl.OrdenProduccionServicio;
...
public class RestApplication extends Application {
	...
	*/
    ...
    public Set<Class<?>> getClasses() {
        ...
        clazzes.add(DespachoMaterialServicio.class);
        clazzes.add(OrdenProduccionServicio.class);
