...
public class ProgDiariaPersonalDAO extends CrudDAO  implements ICrudDAO
{
	...
	{ 
		...
		parametros.add(new SentenciaParametroDAO("p_REGISTRADO_EN_IDC", ((ProgramacionDiariaOE)OE).getPersonal().getRegistradoIdc(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));	
