...
public final class MantenimientoVialEventoDAO extends GenericoDAO implements IMantenimientoVialEventoDAO {
	...
	public ObjetoSalida insertar(MantenimientoVialEventoOE OE) {
        ...
        try {
            ...
            // Actualmente en produccion
            parametros.add(new SentenciaParametroDAO("p_id_tipo_ejecucion", OE.getMantenimientoVialEvento().getIdTipoEjecucion(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));            
            parametros.add(new SentenciaParametroDAO("p_id_tipo_clase", OE.getMantenimientoVialEvento().getIdTipoClase(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));            
            parametros.add(new SentenciaParametroDAO("p_id_tipo_rutas_transporte", OE.getMantenimientoVialEvento().getIdTipoRutasTransporte(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));            
            // Nuevos campos en mantenimiento vial evento desarrollo y pruebas
            parametros.add(new SentenciaParametroDAO("p_numero_carriles", OE.getMantenimientoVialEvento().getNumeroCarriles(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_numero_losas", OE.getMantenimientoVialEvento().getNumeroLosas(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_intervencion_longitud", convertirBigDecimalaDouble(OE.getMantenimientoVialEvento().getIntervencionLongitud()), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_intervencion_ancho", convertirBigDecimalaDouble(OE.getMantenimientoVialEvento().getIntervencionAncho()), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_intervencion_area", convertirBigDecimalaDouble(OE.getMantenimientoVialEvento().getIntervencionArea()), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_coi", OE.getMantenimientoVialEvento().getCoi(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            parametros.add(new SentenciaParametroDAO("p_fecha_radicado_pmt", obtenerFecha(OE.getMantenimientoVialEvento().getFechaRadicadoPmt()), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.DATE));
            parametros.add(new SentenciaParametroDAO("p_id_archivo_coi_pmt", OE.getMantenimientoVialEvento().getIdArchivoCoiPmt(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_id_programacion_periodica", OE.getMantenimientoVialEvento().getIdProgramacionPeriodica(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_id_tipo_calificacion_pci", OE.getMantenimientoVialEvento().getIdTipoCalificacionPci(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_id_tipo_estado_obra", OE.getMantenimientoVialEvento().getIdTipoEstadoObra(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_id_tipo_estado_pmt", OE.getMantenimientoVialEvento().getIdTipoEstadoPmt(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_id_unidad_ejecutora", OE.getMantenimientoVialEvento().getIdUnidadEjecutora(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));            
            parametros.add(new SentenciaParametroDAO("p_intervencion_km_carril", OE.getMantenimientoVialEvento().getIdTipoGrupo(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_numero_radicado_pmt", OE.getMantenimientoVialEvento().getNumeroRadicadoPmt(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            parametros.add(new SentenciaParametroDAO("p_numero_radicado_sdm_pmt", OE.getMantenimientoVialEvento().getNumeroRadicadoSdmPmt(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            parametros.add(new SentenciaParametroDAO("p_observaciones_pmt", OE.getMantenimientoVialEvento().getObservacionesPmt(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
            parametros.add(new SentenciaParametroDAO("p_observaciones_priorizacion", OE.getMantenimientoVialEvento().getObservacionesPriorizacion(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
	...
	public ObjetoSalida actualizar(MantenimientoVialEventoOE OE) {
        ...
        try {
            ...
            /*
             *  p_numero_carriles IN   tab_mantenimiento_vial_evento.numero_carriles%TYPE DEFAULT NULL,
		        p_numero_losas IN   tab_mantenimiento_vial_evento.numero_losas%TYPE DEFAULT NULL,
		        p_intervencion_longitud IN   tab_mantenimiento_vial_evento.intervencion_longitud%TYPE DEFAULT NULL,
		        p_intervencion_ancho IN   tab_mantenimiento_vial_evento.intervencion_ancho%TYPE DEFAULT NULL,
		        p_intervencion_area IN   tab_mantenimiento_vial_evento.intervencion_area%TYPE DEFAULT NULL,
		        p_coi IN   tab_mantenimiento_vial_evento.coi%TYPE DEFAULT NULL,
		        p_fecha_radicado_pmt IN   tab_mantenimiento_vial_evento.fecha_radicado_pmt%TYPE DEFAULT NULL,
		        p_id_archivo_coi_pmt IN   tab_mantenimiento_vial_evento.id_archivo_coi_pmt%TYPE DEFAULT NULL,
		        p_id_programacion_periodica IN   tab_mantenimiento_vial_evento.id_programacion_periodica%TYPE DEFAULT NULL,
		        p_id_tipo_calificacion_pci IN   tab_mantenimiento_vial_evento.id_tipo_calificacion_pci%TYPE DEFAULT NULL,
		        p_id_tipo_estado_obra IN   tab_mantenimiento_vial_evento.id_tipo_estado_obra%TYPE DEFAULT NULL,
		        p_id_tipo_estado_pmt IN   tab_mantenimiento_vial_evento.id_tipo_estado_pmt%TYPE DEFAULT NULL,
		        p_id_tipo_estado_prog_visita IN   tab_mantenimiento_vial_evento.id_tipo_estado_prog_visita%TYPE DEFAULT NULL,
		        p_id_tipo_grupo IN   tab_mantenimiento_vial_evento.id_tipo_grupo%TYPE DEFAULT NULL,
		        p_id_unidad_ejecutora IN   tab_mantenimiento_vial_evento.id_unidad_ejecutora%TYPE DEFAULT NULL,
		        p_intervencion_km_carril IN   tab_mantenimiento_vial_evento.intervencion_km_carril%TYPE DEFAULT NULL,
		        p_numero_radicado_pmt IN   tab_mantenimiento_vial_evento.numero_radicado_pmt%TYPE DEFAULT NULL,
		        p_numero_radicado_sdm_pmt IN   tab_mantenimiento_vial_evento.numero_radicado_sdm_pmt%TYPE DEFAULT NULL,
		        p_observaciones_pmt IN   tab_mantenimiento_vial_evento.observaciones_pmt%TYPE DEFAULT NULL,
		        p_observaciones_priorizacion IN   tab_mantenimiento_vial_evento.observaciones_priorizacion%TYPE DEFAULT NULL,          
