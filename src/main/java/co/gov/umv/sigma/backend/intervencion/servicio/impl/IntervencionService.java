...
public class IntervencionService implements IIntervencionService{
	...
	@Override
	public Response filtrarTipoClaseMaterial(IntervencionOE OE) {
		TipoClaseMaterialDTO dto = new TipoClaseMaterialDTO();
		ObjetoSalida os = dto.filtrarTipoClaseMaterial(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	@Override
	public Response listarApoyoXDirectorXZona(ObjetoEntrada OE) {
		ConfiguracionPersonalDTO dto = new ConfiguracionPersonalDTO();
		ObjetoSalida os = dto.listarApoyoXDirectorXZona(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}


	@Override
	public Response listarResidenteXDirectorXZona(ObjetoEntrada OE) {
		ConfiguracionPersonalDTO dto = new ConfiguracionPersonalDTO();
		ObjetoSalida os = dto.listarResidenteXDirectorXZona(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	
	@Override
	public Response listarResidentesXDirector(ObjetoEntrada OE) {
		ConfiguracionPersonalDTO dto = new ConfiguracionPersonalDTO();
		ObjetoSalida os = dto.listarResidentesXDirector(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	
	@Override
	public Response listarApoyosXDirector(ObjetoEntrada OE) {
		ConfiguracionPersonalDTO dto = new ConfiguracionPersonalDTO();
		ObjetoSalida os = dto.listarApoyosXDirector(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
	...
	@Override
	public Response eliminarPKsProgramacionPeriodica(IntervencionOE OE) {
		GestionProgramacionPeriodicaDTO dto = new GestionProgramacionPeriodicaDTO();
		ObjetoSalida os = dto.eliminarPKsProgramacionPeriodica(OE);	
		return Response.status(Response.Status.OK).entity(os).build();
	}
