...
import co.gov.umv.sigma.backend.produccion.dao.impl.DespachoMaterialDAO;

public class DespachoMaterialDTO implements ICrudDTO
{

	DespachoMaterialDAO modelo = new DespachoMaterialDAO();
