...
public class FranjaHorariaOE extends ObjetoEntrada {
    ...
    private boolean validarDistribucion=false; 
	...
	public boolean isValidarDistribucion() {
		return validarDistribucion;
	}
	public void setValidarDistribucion(boolean validarDistribucion) {
		this.validarDistribucion = validarDistribucion;
	}
