...
public class GestionProgramacionDiariaDAO  extends CrudDAO   
{
	...
	public ObjetoSalida listarConsolidado(ProgramacionDiariaOE OE) 
	{
        ...
        return ejecutar(OE, PACKAGE+".prc_consultar_Consolidado_TrabajoDiario", parametros);
	}
	...
	public ObjetoSalida asignarMaquinaria(ProgramacionDiariaOE OE) 
	{
        ...
        parametros.add(new SentenciaParametroDAO("p_id_tipo_asignacion", OE.getIdTipoAsignacion(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
        ...
        parametros.add(new SentenciaParametroDAO("p_id_progdiaria_maquinaria", OE.getMaquinaria().getIdProgdiariaMaquinaria() , SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
         
        return ejecutar(OE, PACKAGE+".prc_asignarMaquinaria", parametros);
	}
	
	public ObjetoSalida actualizarCampoDetalle(ObjetoEntrada OE) {
		List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
    	
    	parametros.add(new SentenciaParametroDAO("p_id", ((ProgramacionDiariaOE)OE).getId(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
    	parametros.add(new SentenciaParametroDAO("p_tipo", ((ProgramacionDiariaOE)OE).getTipo(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
    	parametros.add(new SentenciaParametroDAO("p_nombre_campo", ((ProgramacionDiariaOE)OE).getNombreCampo(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
    	parametros.add(new SentenciaParametroDAO("p_valor_campo", ((ProgramacionDiariaOE)OE).getValorCampo(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.VARCHAR));
    	
        return ejecutar(OE, PACKAGE+".prc_actualizarCampoDetalle", parametros);
	}
}
