...
public class GestionOE extends ObjetoEntrada {
	...
	private List<Long> idsMantenimientosViales = new ArrayList<Long>();
	private List<Long> idsMantenimientosVialesEventos = new ArrayList<Long>();
	private List<Long> idsDocumentos = new ArrayList<Long>();
	...
	public List<Long> getIdsMantenimientosViales() {
		return idsMantenimientosViales;
	}

	public void setIdsMantenimientosViales(List<Long> idsMantenimientosViales) {
		this.idsMantenimientosViales = idsMantenimientosViales;
	}

	public List<Long> getIdsMantenimientosVialesEventos() {
		return idsMantenimientosVialesEventos;
	}

	public void setIdsMantenimientosVialesEventos(List<Long> idsMantenimientosVialesEventos) {
		this.idsMantenimientosVialesEventos = idsMantenimientosVialesEventos;
	}
	...
	public Long getIdActividadTarea() {
		return idActividadTarea;
	}

	public void setIdActividadTarea(Long idActividadTarea) {
		this.idActividadTarea = idActividadTarea;
	}
